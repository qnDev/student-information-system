...
//        send();
        ...
        EventQueue.invokeLater(() -> {
            new AdminLogin.BackgroundWorker().execute();
    ...
    public void send() {
        ...
        if (user.equals(strnull) || getPasswordTextField.equals(strnull)) {
            JOptionPane.showMessageDialog(null, "Username và mật khẩu không được trống!");
            this.resetForm();
        } else if (DBConnect.open()) {
            try {
                //ps = DBConnect.cnn.prepareCall("call check_admin_login()");
                ps = DBConnect.cnn.prepareStatement("SELECT user_name, password, is_admin FROM dang_nhap WHERE user_name=? AND password=? AND is_admin=?");
                ps.setString(1, user);
                ps.setString(2, getPasswordTextField);
                ps.setString(3, role);
                rs = ps.executeQuery();
                ...
                if (rs.next()) {
                    ...
                    boolean encryptedPassword = PasswordUtils.checkPassword(getPasswordTextField, getPasswordDatabase);
...
//        //AddUser theUser = new AddUser();
//        String strnull = "";
//        //String user = jtfUsername.getText();
//        String plainTextPassword = new String(jpPassword.getPassword());
//        String user = jtfUsername.getText();
//        String role = "admin";
//        
//        try {
//            // get the user id
//            if (user.equals(strnull)) {
//                JOptionPane.showMessageDialog(null, "UserName And PassWord Isn't Null !");
//                this.resetForm();
//            }
//            //AddUser theUser = (AddUser) jtfUsername.getText();
//            theUser.setUser_name(user);
//            theUser.setPassword(plainTextPassword);
//           // theUser.setIs_admin(role);
