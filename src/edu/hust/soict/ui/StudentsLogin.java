...
import edu.hust.soict.ui.student.Search;
...
public class StudentsLogin extends javax.swing.JFrame {
    ...
    public void send() {
        ...
        if (user.equals(strnull) || pass.equals(strnull)) {
            JOptionPane.showMessageDialog(StudentsLogin.this, "UserName And PassWord Isn't Null !");
            this.resetForm();
        } else if (DBConnect.open()) {
            try {
                ps = DBConnect.cnn.prepareCall("{call validation_login()}");
//              ps1 = DBConnect.cnn.prepareCall("call check_student_login_with_tuition()");
//              ps1 = DBConnect.cnn1.prepareStatement("SELECT Name_exp_4 FROM view_hoc_phi_SV WHERE id_sinh_vien_DK =" + user);
                rs = ps.executeQuery();
//              rs1 = ps1.executeQuery();
                ...
                while (rs.next()) {
                    ...
                    // Double tuition = rs1.getDouble("Name_exp_4");
                    if ((user.equals(username)) && (encryptedPassword == true) && (role.equals(is_admin))) {
                        ...
                        ThongTinSV thongtinsv = new ThongTinSV(username, name, ngay_sinh, lop_hoc, chuong_trinh_DT, trang_thai, email, he_hoc);
                        ...
                        dispose();
                        JOptionPane.showMessageDialog(StudentsLogin.this, "You are logged in !");
